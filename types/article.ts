...
export interface Article {
 ...
 export const mockArticles: Article[] = [
    { id: 1, 
      ...
      description: "Cozy, casual holiday game for all ages. Play as Bean, a precocious young ferret, and explore the town of Bellflower, Colorado as you hang up festive string lights around to spread holiday cheer. Click to throw a light or decoration; the only limit is your imagination." ,
    ...
    { id: 4,  
      ...
      description: "The colorful Thrifty Business simulator will show the life of a thrift store in 2026",
      category: "Simulator",
